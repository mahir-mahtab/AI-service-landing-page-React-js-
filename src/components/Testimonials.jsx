      ...
      <div className="flex flex-wrap justify-center">
        {testimonials.map((testimonial, index) => (
          <div key={index} className="w-full px-4 py-2 sm:w-1/2 lg:w-1/3">
            <div className="p-6 font-thin duration-300 border rounded-md shadow-md hover:scale-105 bg-neutral-900 text-md border-neutral-800 shadow-neutral-300 hover:transform">
